    ...
    ar: {
      ...
      highlights: [
        ...
        },
        {
          title: "جاهز للتعريب",
          description:
            "يعطي التوجيه المحلي في المسارات ومساعدات SEO والتعامل مع اتجاه النص أساسا قويا للتوسع متعدد اللغات لاحقا.",
        },
        {
          title: "مناسب للمطور الفردي",
          description:
            "يبدأ المشروع كتطبيق موحد واضح البنية دون بنية تحتية إضافية قبل أن تصبح هناك حاجة حقيقية لها.",
        },
      ],
    },
  } as const;
...
export function getEntityIndexCopy(locale: Locale) {
  const dictionary = {
    ...
    ar: {
      ...
      description:
        "تم تصميم صفحة القائمة الأولى بشكل عام حتى تستطيع البنية نفسها دعم المقالات والعلماء والكتب والأحداث والتصنيفات من أساس واحد متماسك.",
    },
  } as const;
